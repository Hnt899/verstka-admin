    ...
    <div className="settings-page">
        ...
        <div className="settings-tabs-inner">
          ...
          <div className="settings-create" ref={createAreaRef}>
            <button
              ...
              type="button"
            >
              Создать аккаунт <span className="settings-create-caret">▼</span>
            </button>
            {isCreateOpen && (
      ...
      <div className="settings-content-wrapper">
        <div className="create-form-page">
          <h2 className="create-form-title">Создать аккаунт</h2>
          <div className="form">
            <div className="form-warning">
              <span className="warning-icon">⚠</span>
              <span>Данные для входа будут отправлены пользователю на почту. Если Вы не укажете пароль, он будет сгенерирован автоматически.</span>
            </div>
