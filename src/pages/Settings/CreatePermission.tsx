    ...
    <div className="settings-page">
        ...
        <div className="settings-tabs-inner">
          ...
          <div className="settings-create" ref={createAreaRef}>
            <button
              ...
              type="button"
            >
              Создать разрешение <span className="settings-create-caret">▼</span>
            </button>
            {isCreateOpen && (
      ...
      <div className="settings-content-wrapper">
        <div className="create-form-page">
          <h2 className="create-form-title">Создать разрешение</h2>
          <div className="form">
            ...
            <div className="form-group">
              <label className="form-label">Правило</label>
              <select className="form-input">
                <option value="">Выберите правило</option>
              </select>
            </div>
            <div className="form-group">
              <label className="form-label">Дочерние элементы</label>
              <select className="form-input">
                <option value="">Выберите дочерние элементы</option>
              </select>
            </div>
